// src/features/foundation-admin/components/FoundationTopbar.jsx
...
const PAGE_TITLES = {
  ...
  '/fa/qr-scan':       'Verifikasi QR Donasi',   
  '/fa/workshops':     'Daftar Workshop',
  '/fa/workshop-add':  'Buat Workshop',
  '/fa/profile':       'Profil Saya',
};

export default function FoundationTopbar({ onMenuToggle }) {
  const { user } = useAuth();
    ...
    <header className="sticky top-0 z-20 bg-white/80 backdrop-blur-sm border-b border-muted px-4 py-3 flex items-center gap-3">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="hidden md:block">
          ...
          <p className="text-xs text-text-muted">Pengelola Panti</p>
        </div>
      </div>
    </header>
  );
