...
export default function VerificationBanner() {
  ...
  if (user?.role !== 'foundation_admin' || isVerified === true) {
    return null;
  }

  return (
    <div className="bg-amber-50 border-b border-amber-200 px-4 py-3 shadow-sm animate-pulse">
      <div className="flex items-center gap-3 max-w-7xl mx-auto">
        ...
        <div className="flex-1">
          ...
          <span className="block text-xs text-amber-600 font-normal mt-0.5">
            Fitur penarikan donasi, pembuatan agenda workshop, dan manipulasi inventaris dinonaktifkan hingga Super Admin menyetujui dokumen legalitas Anda.
          </span>
        </div>
      </div>
    </div>
